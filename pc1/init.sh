...
ip addr add 10.0.0.1/24 dev eth1 || echo "Warning: Failed to add IPv4 addr for pc1 or already exists."
ip route replace default via 10.0.0.2 dev eth1 || echo "Warning: Failed to set IPv4 default route for pc1 or already exists."
ip -6 addr add 2001:fa::2/64 dev eth1 || echo "Warning: Failed to add IPv6 addr for pc1 or already exists."
ip -6 route replace default via 2001:fa::1 dev eth1 || echo "Warning: Failed to set IPv6 default route for pc1 or already exists."
